...
import fragments.BiometricFragment
    ...
    private fun init() {
        ...
        callBack = object : BiometricPrompt.AuthenticationCallback() {
            override fun onAuthenticationFailed() {
                ...
                Toast.makeText(this@BiometricActivity, getString(R.string.error_unknown), Toast.LENGTH_LONG).show()
            }

            override fun onAuthenticationSucceeded(result: BiometricPrompt.AuthenticationResult) {
                super.onAuthenticationSucceeded(result)
                Toast.makeText(this@BiometricActivity, getString(R.string.message_success), Toast.LENGTH_LONG).show()
                Sharepref.setBoolean(this@BiometricActivity, "app_locked", true)
                Sharepref.setBoolean(this@BiometricActivity, "recent_app_status", false)
                ActivityCompat.finishAffinity(this@BiometricActivity)

            }

            override fun onAuthenticationError(errorCode: Int, errString: CharSequence) {
                super.onAuthenticationError(errorCode, errString)
                Toast.makeText(this@BiometricActivity, getErrorMessage(errorCode), Toast.LENGTH_LONG).show()
            }
        }
