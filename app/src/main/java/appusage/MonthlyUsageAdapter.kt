...
class MonthlyUsageAdapter(private val context: Context, private var mList: ArrayList<ListMonthlyModel>) : RecyclerView.Adapter<MonthlyUsageAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MonthlyUsageAdapter.ViewHolder {
        // inflates the card_view_design view
        // that is used to hold list item
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.app_list, parent, false)

        return MonthlyUsageAdapter.ViewHolder(view)
    }

    // binds the list items to a view
    override fun onBindViewHolder(holder: MonthlyUsageAdapter.ViewHolder, position: Int) {
